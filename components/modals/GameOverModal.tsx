...
export const GameOverModal: React.FC<GameOverModalProps> = ({
  ...
  return (
    ...
    <div className="absolute inset-0 z-30 bg-red-900/20 backdrop-blur-sm flex items-center justify-center p-4 pt-[max(6rem,calc(env(safe-area-inset-top)+4rem))] pb-[max(6rem,calc(env(safe-area-inset-bottom)+4rem))] md:p-4">
